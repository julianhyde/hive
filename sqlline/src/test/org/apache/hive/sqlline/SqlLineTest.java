...
public class SqlLineTest {
  ...
  public void testNPE() throws UnsupportedEncodingException {
    ...
    sqlLine.runCommands(callback, "!typeinfo");
    ...
    sqlLine.runCommands(callback, "!nativesql");
  ...
  @Test public void testManual() {
    ...
    line.runCommands(new DispatchCallback(), "!manual");
    ps.flush();
  ...
  // until we upgrade to junit-4.13
  ...
  // until we upgrade to junit-4.13
  public static class StringContains extends SubstringMatcher {
